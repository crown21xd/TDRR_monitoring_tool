...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
params.num_receive_antennas = 8;                    % number of receive antennas
params.num_transmit_antennas = 2;                    % number of transmit antennas and data streams
params.num_channel_taps = 4;                    % number of channel taps
...
params.modulation_scheme = 'QPSK';             % transmit constellation
