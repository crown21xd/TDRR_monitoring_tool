...
for trial_index=1:num_trials
  ...
  for snr_index = 1:length(snr_dB_list)
    ...
    for tone_index=1:num_used_subcarriers
      ...
      symbols_estimate_jammerless = (sqrt(num_subcarriers)*(user_channel_frequency_tones(:,:,tone_index)))\squeeze(y_jammerless_frequency_tones(:,tone_index,:));  % zero-forcing estimate jammerless
